...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults.column = {
		 ...
		 *    // sorting, filtering and display. In this case, currency (contract_amount)
		 *    $(document).ready( function() {
		 *      $('#example').dataTable( {
		 *        "columnDefs": [ {
		 *          "targets": [ 0 ],
		 ...
		 *              source.contract_amount_display = val=="" ? "" : "$"+numberFormat(val);
		 *              source.contract_amount_filter  = val=="" ? "" : "$"+numberFormat(val)+" "+val;
		 *              return;
		 *            }
		 ...
		 *            }
		 *            else if (type === 'filter') {
		 *              return source.contract_amount_filter;
		 *            }
