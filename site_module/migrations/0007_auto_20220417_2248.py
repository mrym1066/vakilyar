    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.CharField(choices=[('movakel_list', 'صفحه لیست پرونده ها'), ('movakel_detail', 'صفحه ی جزییات پرونده ها'), ('about_us', 'درباره ما')], max_length=200, verbose_name='جایگاه نمایشی')),
            ],
            options={
